                        ...
                        <Card className="dashboard-card about-airline">
                            <CardContent>
                                <Typography variant="h6" className="card-title">
                                    About Skylink Airways
                                </Typography>
                                <Box className="airline-content">
                                    <Typography variant="body1" className="airline-description">
                                        Skylink Airways is a premier airline committed to providing exceptional service and comfort to our passengers. With a fleet of modern aircraft and a team of experienced professionals, we ensure a safe and enjoyable journey for all our customers.
                                    </Typography>
